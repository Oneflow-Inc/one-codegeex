...
#  
CMD="/home/zhangxiaoyu/nsight-systems-2022.4.1/bin/nsys profile --stats=false -o codegeex_oneflow_optimize.qdrep python -u $MAIN_DIR/tests/test_inference_oneflow.py \
